...
Hyd.recvobject(eo,"Employee") # calling Class Level method by Class name
Hyd.dispobjinfo(so,"Student") # calling Class Level method by Class name
Hyd.dispobjinfo(to,"Teacher") # calling Class Level method by Class name
