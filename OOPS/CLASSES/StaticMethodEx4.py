...
Hyd().dispobjinfo(eo,"Employee") # calling static method by using Name-Less object
Hyd().dispobjinfo(so,"Student") # calling static method by using Name-Less object
Hyd().dispobjinfo(to,"Teacher") # calling static method by using Name-Less object
